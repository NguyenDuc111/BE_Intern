...
import { getAllPromotions, createPromotion, updatePromotion, deletePromotion } from '../controllers/PromotionController.js';
import { isAuthenticated, isAdmin } from '../middleware/auth.js';

const router = express.Router();

//endpoint xem danh sách khuyến mãi
router.get('/promotion', isAuthenticated, isAdmin, getAllPromotions);
